...
Abra o arquivo `index.html` no navegador. Para uma experiência mais próxima da publicação, use uma extensão de servidor local, como Live Server no VS Code.
...
3. Fonte, tratamento e qualidade dos dados.
4. Modelo de dados e medidas utilizadas.
